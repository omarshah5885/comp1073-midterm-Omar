...
var travelReport = (function () {
	...
	// capture form data via the console
	// step 1: define variables via Id's in DOM
	...
	// step 2: create an event handler to capture info upon click of submit while preventing button from processing results so they can be displayed on console
